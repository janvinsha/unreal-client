      ...
      */
      ...
      pools = [
        ...
        },
        {
          ...
          icon: {
            logoURI:
              'https://s2.coinmarketcap.com/static/img/coins/64x64/8497.png',
          },
      ...
      */
      ...
      pools = [
        ...
        },
        {
          ...
          icon: {
            logoURI:
              'https://d2kfoba0ei9gzz.cloudfront.net/img/51fee159c3456c1168ccfa3f67bd0cad.png',
          },
          size: sumThree / totalParts,
        },
      ];
      ...
      pools = [
        {
          ...
          icon: {
            logoURI:
              'https://assets.coingecko.com/coins/images/14565/small/mochi.png?1617030087',
          },
          size: sumOne / totalParts,
        },
        {
      ...
      */
      ...
      pools = [
        ...
        },
        {
          ...
          icon: {
            logoURI:
              'https://assets.coingecko.com/coins/images/21955/small/wannaswap.PNG?1640337839',
          },
          size: sumTwo / totalParts,
        },
        {
